import DepositButton from "@/app/(main)/components/depositButton";
import TransferTable from "@/app/(main)/components/transferTable";
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-12 gap-3">
        ...
        <section className="col-span-4">{/* vai ter isso? */}</section>
